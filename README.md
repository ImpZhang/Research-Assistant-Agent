...
- Project handoff bundle export that packages project overviews, readiness, quality gates, opportunity radar, task board state, briefs, and research plans.
