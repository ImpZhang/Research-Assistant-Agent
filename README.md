...
- Deterministic bad-case replay script for saved `ReplayCase` rows, source agent runs, and tool-call records, plus opt-in local context-search/citation live replay and replay-run trace recording, with JSON/Markdown reports and focused local validation.
