...
- brief 需要包含相关 research execution plans、plan task progress、readiness signals、evidence ledger signals、claim validation queue/task signals、triage signals 和 latest triage snapshot comparison。
