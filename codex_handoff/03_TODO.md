...
- Added focused upload guardrail coverage for allowed-extension overrides, allowed-extension normalization, case-insensitive extension matching, invalid max-byte fallback, empty uploads, Markdown default-extension ingestion, path-traversal filename sanitization, and non-UTF-8 text rejection before file writes.
