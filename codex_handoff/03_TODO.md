...
- Added focused upload guardrail coverage for allowed-extension overrides, empty uploads, Markdown default-extension ingestion, path-traversal filename sanitization, and non-UTF-8 text rejection before file writes.
