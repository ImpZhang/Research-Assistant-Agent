...
- Added `scripts/check_context_search_evaluations.sh` as the focused remote check for context-search ranking, query-term deduplication, lower/upper limit-clamping, guard, filter, score-breakdown, and graph-context fixtures.
